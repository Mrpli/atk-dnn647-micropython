 ...
 */
#define CMW_EXPOSUREMODE_AUTO          0x00U   /* Start the camera auto exposure functionality */
#define CMW_EXPOSUREMODE_AUTOFREEZE    0x01U   /* Stop the camera auto exposure functionality and freeze the current value */
